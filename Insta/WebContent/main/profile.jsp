...
<body>
	...
	<div class="row" id="profile">
		...
		<div id="profile_detail" class="col-md-8">
				...
				<span id="span_btn"><a href="/my/account/edit.jsp"><button id="btn_profile" type="button" class="btn btn-default" onClick="edit_profile()"><strong>팔로우</strong></button></a></span>
